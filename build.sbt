  ...
  .settings(
    libraryDependencies ++= {
      Seq(
        ...
        "software.amazon.awssdk" % "autoscaling" % "2.21.25",
        "software.amazon.awssdk" % "sns" % "2.21.25",
        "software.amazon.awssdk" % "ec2" % "2.21.25",
        "software.amazon.awssdk" % "cloudformation" % "2.21.25",
      )
    }
  )
  .dependsOn(
